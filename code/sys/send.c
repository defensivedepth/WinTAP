...
--*/
{
    ...
    do
    {
       ...
       */
        if (!NPROT_MEM_CMP(pEthHeader->DstAddr, pOpenContext->CurrentAddress, NPROT_MAC_ADDR_LEN))
        {
            DEBUGP(DL_WARN, ("Write: Failing with invalid destination address"));
            NtStatus = STATUS_INVALID_PARAMETER;
            break;
        }
...
--*/
{
            ...
            CurrNetBufferList = NextNetBufferList)
    {
        ...
        DEBUGP(DL_INFO, ("SendComplete: NetBufferList %p/IRP %p/Length %I64u "
