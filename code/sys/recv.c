...
--*/
{
    ...
    while (pNetBufList != NULL)
    {
        ...
        {
			//
			// Leave the packet if it is loopback.
            ...
            if (pEthHeader->EthType == NPROT_8021P_TAG_TYPE)
            {
                ...
                {
                    //break; //We need to be indicated of all frames not just IPv4.
                }
            ...
            DEBUGP(DL_LOUD, ("ReceiveNetBufferList: From %02x:%02x:%02x:%02x:%02x:%02x,    \
